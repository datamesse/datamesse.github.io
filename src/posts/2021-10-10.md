...
The final product is being able to use a Parameter to select a desired time zone, and apply it to your dataset's "Date/Time" column, and prodduce a "Date/Time/Zone" value.
